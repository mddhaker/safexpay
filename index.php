...
<BODY>
<form class="form-horizontal" action="http://localhost/safexpay/send_data.php" method="post">
      ...
      <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
					  <input type="text" class="form-control" name="merchant_key" id="merchant_key" value="MERCHANT_ID" />
					 </div>
                    </div>
                  </div>
